...
class DataPreprocessTest():
    ...
    def GetDataConcat(self):
        ...
        test_loaderF       =  DataLoader(test_Dataset,batch_size=1, shuffle=False, drop_last=False)
        ...
        sampledataT   =  dataT[0]
        condataT      = condata.to(device)


        
        return test_Dataset,test_loaderF,sampledataT,dataT,labelsT,condataT,indexofdata,labelnames
