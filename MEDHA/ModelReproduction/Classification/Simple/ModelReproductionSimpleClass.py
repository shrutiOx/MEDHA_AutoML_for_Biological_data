...
class ModelReproduction(nn.Module):
    def __init__(self,
        ...
        self.mainmodel_statedict     = mainmodel_statedict
    ...
    def GetModel(self):
        ...
        self.modelfinal.load_state_dict(torch.load(self.mainmodel_statedict))

        return self.modelfinal