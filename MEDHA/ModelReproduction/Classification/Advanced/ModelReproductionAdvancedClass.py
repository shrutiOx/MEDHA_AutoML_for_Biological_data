# -*- coding: utf-8 -*-
"""
Created on Thu Aug 24 23:53:58 2023
...
f.state dict of modelDART
g.state dict of modelFold

2.This function then should unload the pkl and see how many outputs are asked
3.Now from the given encoding type, it will create 1 toy examples with number of predictions = number of out-channels specified in the pkl. This is same as simple
...
7.Now it will wrap the best-model with this placeholder and create final modelDart which it will output.You will need this.
8.Now it will call DNN/LSTM class depending on Parameterlist
9.It will put the parameters and create a holder for modelFold.
10.It will wrap modelFold on this
11.Final model is created for modelFold. You will need this.
8.Next user calls DataProcessor test
9.Next runs Semi-manual test with the recieved models 9you need to call advanced test prediction module) and get the results.
10.Put 'ModelReproduction' from Advanced same to same for classification and regression. 
