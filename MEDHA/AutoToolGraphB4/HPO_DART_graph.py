...
class HPO_DART(nn.Module):
    ...
    def evaluate_model(self,myspace):
            ...
            if DARTacc >=  self.acc_thresold:
                ...
                return {'loss': (1000 - DARTacc), 'status': STATUS_OK, 'model': None,'space': self.space,'ParameterList': ParameterList,'avg-train-loss': None,'avg-test-accuracy':None,'avg-val-accuracy':None,'test_acc_std':None}
